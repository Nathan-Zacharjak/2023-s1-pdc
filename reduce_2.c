...
// the timing output
// As well, line 147 has been modified to make the forces
// be calculated using a block partitioning rather than
// a cyclic one
#define NO_OUTPUT
...
// #        pragma omp for schedule(static,1)
         // The above line has been modified to the below
         // to remove the "schedule" modifier
         // as this is what is responsible for introducing
         // cyclic partitioning in the first phase of the
         // calculating forces parallel for loop
#        pragma omp for
